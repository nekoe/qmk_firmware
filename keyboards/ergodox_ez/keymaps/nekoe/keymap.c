...
#define LNG_E   KC_LANG2
#define LNG_J   KC_LANG1
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    ____,    ____, ____, ____, LNG_E,                                                   LNG_J, ____,    KC_LEFT, KC_RGHT, KC_DOWN,
                                            KC_QUOT, KC_BSLS,   ____,    KC_GRV,
                                                     ____,      KC_CAPS,
                                    SPC_L1, KC_LGUI, ____,      KC_RALT, KC_RCTL, ENT_L1
  ),
