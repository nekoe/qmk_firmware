...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        TAB_OPT,  KC_A,     KC_S,  KC_D,   KC_F,    KC_G,     KC_H,    KC_J,    KC_K,     KC_L,    KC_SCLN,
        KC_LSFT,  KC_Z,     KC_X,  KC_C,   KC_V,    KC_B,     KC_N,    KC_M,    KC_COMM,  KC_DOT,  KC_SLSH,
        KC_LGUI,  KC_LCTL,  MO(3), EN_L1,  SPC_L2,            ENT_L2,  JP_CMD,  KC_LBRC,  KC_RBRC, KC_BSLS
    ),

    [1] = LAYOUT(
        KC_GRV,   KC_1,     KC_2,  KC_3,   KC_4,    KC_5,      KC_6,   KC_7,    KC_8,     KC_9,     KC_0,    KC_EQL,
        TAB_OPT,  ____,     ____,  ____,   ____,    ____,      ____,   ____,    ____,     ____,     KC_QUOT,
    ...
    [2] = LAYOUT(
        ...
        ____,     CTL(A),  CMD(S),  KC_DEL,  KC_RGHT, ____,       KC_BSPC,  ____,    CTL(K),  ____,  ____,
        KC_LSFT,  CMD(Z),  CMD(X),  CMD(C),  CMD(V),  KC_LEFT,    KC_DOWN,  ____,    ____,    ____,  ____,
        ____,     ____,     ____,   EN_L1,   SPC_L2,              CMD(ENT), JP_CMD,  ____,    ____,  ____
    ),
