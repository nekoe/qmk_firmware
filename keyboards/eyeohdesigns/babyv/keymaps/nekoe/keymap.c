...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [0] = LAYOUT_1u(
        ...
        L3,                     KC_LCTL,  EN_L1,  SPC_L2,     ENT_L2,  JP_CMD,  ____,                        ____
    ),
    [1] = LAYOUT_1u(
        ...
        ____,                   KC_LCTL,  EN_L1,  SPC_L2,     ENT_L2,  JP_CMD,  ____,                   ____
    ),
    [2] = LAYOUT_1u(
        ...
        ____,                       KC_LCTL,  EN_L1,    SPC_L2,      CMD(ENT),  JP_CMD,  ____,                   ____
    ),
    [3] = LAYOUT_1u(
        ____,  ____,  ____,  ____,  ____,  ____,     ____,  ____,  ____,  ____,  ____,  ____,\
        ____,  ____,  ____,  ____,  ____,  ____,     ____,  ____,  ____,  ____,  ____,  ____,\
        ____,  ____,  ____,  ____,  ____,  ____,     ____,  ____,  ____,  ____,  ____,  ____,\
        ____,                ____,  ____,  ____,     ____,  ____,  ____,                RESET
    ),
};
